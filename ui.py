...
class UserInterface(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.button_squareroot.setText(_translate("Form", "√"))
        ...
        self.button_reciprocal.setText(_translate("Form", "1/x"))
        self.button_square.setText(_translate("Form", "x²"))
        self.button_ce.setText(_translate("Form", "CE"))
        self.button_seven.setText(_translate("Form", "7"))
        self.button_divide.setText(_translate("Form", "÷"))
        self.button_eight.setText(_translate("Form", "8"))
        self.button_nine.setText(_translate("Form", "9"))
        self.button_multiply.setText(_translate("Form", "x"))
        self.button_five.setText(_translate("Form", "5"))
        self.button_modulus.setText(_translate("Form", "%"))
        self.button_backspace.setText(_translate("Form", "<<"))
        self.button_four.setText(_translate("Form", "4"))
        self.button_six.setText(_translate("Form", "6"))
        self.button_plusminus.setText(_translate("Form", "±"))
        self.button_zero.setText(_translate("Form", "0"))
        self.button_decimal.setText(_translate("Form", "."))
        self.button_equals.setText(_translate("Form", "="))
        self.label.setText(_translate("Form", "Standard Mode"))
        self.pushButton_26.setText(_translate("Form", "MC"))
        self.pushButton_25.setText(_translate("Form", "MR"))
        self.pushButton_27.setText(_translate("Form", "M+"))
        self.pushButton_28.setText(_translate("Form", "M-"))
        self.pushButton_29.setText(_translate("Form", "MS"))
        self.text_expression.setPlaceholderText(_translate("Form", "expression or command here."))
        self.line_result.setPlaceholderText(_translate("Form", "result."))