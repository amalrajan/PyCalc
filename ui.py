...
class UserInterface(object):
    ...
    def initialize_ui(self, Form):
        ...
        self.line_expression = QtWidgets.QLineEdit(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.line_expression.sizePolicy().hasHeightForWidth())
        self.line_expression.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Courier New")
        font.setPointSize(13)
        self.line_expression.setFont(font)
        self.line_expression.setToolTip("")
        self.line_expression.setToolTipDuration(3)
        self.line_expression.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.line_expression.setStyleSheet(
            "QLineEdit{\n"
            "    border: 0;\n"
            "}")
        # self.line_expression.setUndoRedoEnabled(False)
        # self.line_expression.setAcceptRichText(False)
        # self.line_expression.setCursorWidth(10)
        self.line_expression.setObjectName("line_expression")
        self.verticalLayout_2.addWidget(self.line_expression)
    ...
    def retranslateUi(self, Form):
        ...
        self.line_expression.setPlaceholderText(_translate("PyCalc", "expression or command here."))
